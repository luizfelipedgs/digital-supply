...
import { EditorMusicasClient } from "./EditorMusicasClient";
import { MAX_VIDEOS_PER_BATCH, BATCH_RETENTION_HOURS } from "@/lib/video-batch-config";

export default async function EditorMusicasPage() {
  ...
  return (
    <div className="min-h-screen bg-ink-900 p-6 sm:p-8">
      <div className="max-w-3xl mx-auto">
        ...
        <EditorMusicasClient initialCredits={profile.video_credits ?? 0} initialIsAdmin={!!profile.is_admin} userId={userData.user.id} />
      </div>
    </div>
  );
}
