...
const nextConfig = {
  experimental: {
    ...
    // __dirname na hora que o pacote é importado. Se o Next.js empacotar
    ...
    // da função serverless da Vercel que processa os vídeos do Editor de
    // Músicas — sem isso a Vercel pode "podar" o arquivo por não detectar
